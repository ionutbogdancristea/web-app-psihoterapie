        ...
        return  (
            <div key={index}> 
              <div className="bg-ana-purple-servicii bg-opacity-20">
                <div className={(index % 2 === 0 ? "md:flex md:justify-between " : "md:flex md:flex-row-reverse md:justify-between ")+ "py-6 px-6 md:px-80 items-center"}>
                    <img src={item.image} alt={item.alt} className="h-56"></img>
                    <div className={(index % 2 === 0 ? "md:ml-5" : "md:mr-5") + " flex flex-col md:mr-6"}>
